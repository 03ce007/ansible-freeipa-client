...
* ``freeipaclient_install_command``: IPA client install command based on the OS type (string, mandatory)
* ``freeipaclient_packages``: List of packages required for IPA client (string, mandatory)
